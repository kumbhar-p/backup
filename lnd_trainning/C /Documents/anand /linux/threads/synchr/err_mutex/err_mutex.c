...
#include<pthread.h>
#include<error.h>
pthread_mutex_t lock,lock1 = PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP; /*not possible to initialize both the mutex  */
pthread_mutex_t lock1,lock = PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP; /* static mutex initialization */
